...
class QA_chain_self():
    ...
    def __init__(self, model_type="OPENAI",model:str="gpt-3.5-turbo", temperature:float=0.0, top_k:int=4,
                 file_path:str=None, persist_path:str=None, appid:str=None, api_key:str=None,

                embedding_type="OPENAI", embedding = None,  embedding_key = None, template=default_template_rq,
                 api_base:str=None,embedding_base:str=None,  spark_api_secret:str=None,spark_app_id:str=None):
        ...
        #self.vectordb = get_vectordb(self.file_path, self.persist_path, self.embedding_type,self.embedding,self.embedding_key,embedding_base=self.embedding_base,
      #                               spark_app_id=self.Spark_app_id,spark_api_secret=self.Spark_api_secret)
        self.llm = model_to_llm(self.model_type,self.model, self.temperature,
                                self.api_key, api_base=self.api_base,max_token=self.max_token,)
