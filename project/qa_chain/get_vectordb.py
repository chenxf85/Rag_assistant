...
def get_vectordb(file_path:str=None, persist_path:str=None, type="OPENAI",embedding = "dafault",
    ...
    """
    embedding = get_embedding(type=type,embedding=embedding, embedding_key=embedding_key,embedding_base=embedding_base,spark_app_id=spark_app_id, spark_api_secret=spark_api_secret)
